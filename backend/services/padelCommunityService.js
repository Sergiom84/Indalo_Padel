...
function mapCommunityPlayerRow(row) {
  return {
    ...
    court_preferences: row.court_preferences || [],
    dominant_hands: row.dominant_hands || [],
    availability_preferences: row.availability_preferences || [],
    match_preferences: row.match_preferences || [],
...
function buildPlanDto(row, participants, currentUserId, extras = {}) {
  ...
  return {
    ...
    calendar_sync_error: row.calendar_sync_error || null,
